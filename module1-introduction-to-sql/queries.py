...
if __name__ == "__main__":
    ...
    print("Total Caracters", CHARACTERS[0])
    print("Total Cleric", CLERIC[0])
    print("Total Fighter", FIGHTER[0])
    print("Total Mage", MAGE[0])
    print("Total Necromancer", NECROMANCER[0])
    print("Total Thief", THIEF[0])
